...
- Calibration (tests/unit/calibration-deplane.test.js and calibration-board.test.js): A320 default, free-for-all deplane median over 30 seeds: whole-run door throughput `passengerCount / totalMinutes` in 14 to 24 pax/min (Milne & Salari 15-17 pax/min low end to Schultz 2018 median 23), first-two-minute door throughput in 15 to 30 pax/min, and total time in a sanity range of 5 to 13 min; random boarding median in 15 to 30 min; at compliance 1.0 and no groups: back-to-front boarding slower than random, steffen faster than wilma faster than random; aisle-first deplaning faster than free-for-all.
